...
import com.tpr.engine.impl.ProcessEngineInfoImpl;
import com.tpr.engine.util.IoUtil;
import com.tpr.engine.util.ReflectUtil;
...
public abstract class ProcessEngines {
    ...
    public synchronized static void init() {
        if (!isInitialized()) { //再次判断流程引擎是否初始化,如果确认没有初始化 执行后续操作 ,否则不予处理
            ...
            try {
                ...
                throw new TprException("problem retrieving activiti.cfg.xml resources on the classpath: " + System.getProperty("java.class.path"), e);
            }
         ...
         */
                ...
                throw new TprException("problem retrieving activiti-context.xml resources on the classpath: " + System.getProperty("java.class.path"), e);
            }
            while (resources.hasMoreElements()) {
    ...
    protected static void initProcessEngineFromSpringResource(URL resource) {
        try {
            ...
            throw new TprException("couldn't initialize process engine from spring configuration resource " + resource.toString() + ": " + e.getMessage(), e);
        }
    }


    /**
     * 初始化流程引擎之Activiti 默认配置风格  ---> 此() 负责解析 activiti.cfg.xml文件中配置的ben信息
    ...
    private static ProcessEngine buildProcessEngine(URL resource) {
       ...
       */
            ...
            throw new TprException("couldn't open resource stream: " + e.getMessage(), e);
        } finally {
