...
public class IoUtil {
  ...
  public static byte[] readInputStream(InputStream inputStream, String inputStreamName) {
    ...
    try {
      ...
      throw new TprException("couldn't read input stream "+inputStreamName, e);
    }
  ...
  public static String readFileAsString(String filePath) {
    ...
    try {
      ...
      throw new TprException("Couldn't read file " + filePath + ": " + e.getMessage());
    } finally {
  ...
  public static File getFile(String filePath) {
    ...
    try {
      ...
      throw new TprException("Couldn't get file " + filePath + ": " + e.getMessage());
    }
  }
  ...
  public static void writeStringToFile(String content, String filePath) {
    ...
    try {
      ...
      throw new TprException("Couldn't write file " + filePath, e);
    } finally {
